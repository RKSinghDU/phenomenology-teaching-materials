...
## 1.1 What Is Phenomenology?

Phenomenology — from the Greek *phainomenon* (that which appears) and *logos* (reasoned account) — is the philosophical and scientific study of the structures of conscious experience as they present themselves to first-person awareness. It asks: what are the essential features of a given type of experience?
...
Developed the **descriptive phenomenological method for psychology** — a systematic, multi-step procedure for analysing participants' first-person descriptions to arrive at general psychological structures.

---

## 1.3 Core Concept: Intentionality

> **Intentionality** — The structural property of consciousness whereby every act of consciousness is directed toward an object or content.

| Term | Definition |
|------|------------|
| **Noesis** | The act of consciousness (perceiving, remembering, fearing, desiring) |
| **Noema** | The intentional content or object as experienced |

Noesis and noema are *correlates* — they cannot be separated.
...
- Refraining from immediately applying diagnostic categories (PTSD, C-PTSD) to participants' descriptions.
- Resisting explaining experience in terms of neurobiological mechanisms before first describing its lived structure.
- Attending to participants' own language and metaphors as primary data.
- Acknowledging and setting aside the researcher's own prior commitments through reflexive memo-writing.
...
| Feature | Can it be removed? | Essential? |
|---------|-------------------|------------|
| Visual vividness | Yes — somatic & olfactory flashbacks exist | No |
| Present-tense immediacy | Removing this turns it into an intrusive memory | **Yes** |
| Involuntariness | A deliberate re-experiencing is not a flashback | **Yes** |
| Intense affect | Low-affect re-experiencing may still qualify | Contested |

**Emerging eidetic structure:** temporal invasion (past overwhelming present), involuntary re-enactment, dissolution of safe temporal distance.
...
- Husserl, E. (1913/1982). *Ideas: General Introduction to Pure Phenomenology* — Parts I & II.
- Heidegger, M. (1927/1962). *Being and Time* — Division One, §§12–42.
- Giorgi, A. (2009). *The Descriptive Phenomenological Method in Psychology* — Chapters 1–3.
- Zahavi, D. (2019). *Phenomenology: The Basics* — Chapters 1–3.
